  ...
  return (
    <div className={c.root}>
      ...
      <main>
        ...
        <p>
          the thing you are trying to find either doesn't exist, is under a different filename, or
          has disappeared...
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <a href='mailto:dave@davecode.me'>tell me about it</a>
          </li>
          <li>
            <a href='https://reddit.com/r/all'>browse memes</a>
          </li>
        </ul>
      </main>
    </div>
